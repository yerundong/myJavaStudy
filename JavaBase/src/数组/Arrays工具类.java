...
public class Arrays工具类 {
    public static void main(String[] args) {
        ...
        {
            // <名称> public static String toString(T[])
            ...
            // <名称> public static String deepToString(Object[])
            // <返回> toString的加强版，返回指定数组“深层内容”的字符串表示形式。
        ...
        {
            // <名称> public static void sort(T[])
            // <修改> 按照默认升序（从小到大）对数组的元素进行排序，修改原数组。
            // <名称> public static void sort(int[] a, int fromIndex, int toIndex)
            // <注>
        ...
        {
            // <名称> public static int hashCode(T[])
            // <返回> 返回哈希码
            // <注> 对于任何两个满足 Arrays.equals(arr1, arr2) 的数组 arr1 和 arr2，也可用说 Arrays.hashCode(arr1) == Arrays.hashCode(arr2)。
            System.out.println("hashCode：" + topArr);
            System.out.println("hashCode：" + Arrays.hashCode(topArr));
            System.out.println("hashCode：" + Arrays.hashCode(new int[]{3, 2, 10, 7, 6}));
        }

        {
            // <名称> public static int deepHashCode(Object[])
            // <返回> hashCode的加强版，将计算其基于深层内容的哈希码的数组
            // <略>
        }

        {
            // <名称> public static boolean equals(T[], T[])
            // <返回> 判断数组元素是否相同，判断机制是：基本类型的元素用==，引用类型的元素用equals
        ...
        {
            // <名称> public static boolean deepEquals(Object[], Object[]))
            // <返回> equals的加强版，用于判断多维数组。判断机制是：基本类型的元素用==，引用类型的元素用equals
        ...
        {
            // <名称> public static T[] copyOf(T[], newLength))
            // <返回> 复制并创建新的数组，从索引0开始复制指定长度 newLength ，长度超出的用默认值填充
            ...
            // <名称> public static T[] copyOfRange(T[], int fromIndex, int toIndex)
            // <返回> 类似copyOf，返回复制后的新数组，从 fromIndex 到 toIndex 复制，长度超出的用默认值填充
            // <注> 只是一层内容复制；如果是多维数组，则复制的是内侧元素的引用地址
        ...
        {
            // <名称> public static int binarySearch(int[] a, int fromIndex, int toIndex, type key)
            // <返回> 使用二分搜索法查找数组元素的出现的索引值（并非第一次出现索引）,fromIndex 和 toIndex 指定查找范围，key是查找关键元素
        ...
        {
            // <名称> public static void fill(int[] a, int fromIndex, int toIndex, int val)
            // <修改> 替换数组元素，从索引 fromIndex（包含） 到 toIndex（不包含） 之间，用 val 替换
            // <名称> public static void fill(int[] a, int val)
            // <修改> 替换所有数组元素
