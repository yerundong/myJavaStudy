...
public class Base {
    ...
    public void Constructor() throws IOException {
        DataOutputStream dos = new DataOutputStream(new FileOutputStream("IOTestFile/dataStream.txt"));
        DataInputStream dis = new DataInputStream(new FileInputStream("IOTestFile/dataStream.txt"));
        dis.close();
        dos.close();
    }
    ...
    public void write() throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream("IOTestFile/dataStream.txt");
