package IO流.commonIO.缓冲流.BufferedReader;
...
public class Base {
    ...
    public void Constructor() throws IOException {
        ...
        File file = new File("JavaSe\\src\\lib\\IOTestFile\\hello-io.txt");
    ...
    public void readLine() throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader(new File("JavaSe\\src\\lib\\IOTestFile\\hello-io.txt")));
        BufferedWriter bw = new BufferedWriter(new FileWriter(new File("JavaSe\\src\\lib\\IOTestFile\\hello-io_copy.txt")));
        String s;
        String str = "";
